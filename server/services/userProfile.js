...
export function userSelectFields() {
  return 'id, personal_id, email, name, email_verified, telegram_chat_id, telegram_username, avatar_url, profile_updated_at, password_changed_at, last_login_at, created_at'
}
