const defaultTheme = {
  ...
  heroOverlayDark: 'linear-gradient(135deg, rgba(8, 8, 14, 0.94) 0%, rgba(99, 102, 241, 0.35) 55%, rgba(168, 85, 247, 0.25) 100%)',
  heroOverlayLight: 'linear-gradient(135deg, rgba(245, 243, 255, 0.96) 0%, rgba(139, 92, 246, 0.18) 55%, rgba(236, 72, 153, 0.12) 100%)',
  icon: '🎓',
}
...
export const courseThemes = {
  ...
  'ai-chatbot-developer': { accent: '#6366f1', accentSoft: 'rgba(99,102,241,0.22)', gradient: 'linear-gradient(135deg, #4f46e5 0%, #6366f1 45%, #a855f7 100%)', heroOverlayDark: 'linear-gradient(135deg, rgba(8,8,14,0.94) 0%, rgba(79,70,229,0.4) 100%)', heroOverlayLight: 'linear-gradient(135deg, rgba(238,242,255,0.97) 0%, rgba(99,102,241,0.2) 100%)', icon: '💬' },
  'ai-voice-developer': { accent: '#06b6d4', accentSoft: 'rgba(6,182,212,0.22)', gradient: 'linear-gradient(135deg, #0891b2 0%, #06b6d4 50%, #6366f1 100%)', heroOverlayDark: 'linear-gradient(135deg, rgba(8,8,14,0.94) 0%, rgba(6,182,212,0.35) 100%)', heroOverlayLight: 'linear-gradient(135deg, rgba(236,254,255,0.97) 0%, rgba(6,182,212,0.18) 100%)', icon: '🎙️' },
